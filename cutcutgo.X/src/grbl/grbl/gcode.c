...
uint8_t gc_execute_line(char *line)
{
      ...
      case 'G':
        ...
        switch(int_value) {
          ...
          case 0: case 1: case 2: case 3: case 38:
            //printString("[GCODE: G(0,1,2,3,38)]\r\n");
      ...
      default:
        ...
        switch(letter){
          ...
          case 'T': word_bit = WORD_T; 
					  if (int_value > MAX_TOOL_NUMBER) { FAIL(STATUS_GCODE_MAX_VALUE_EXCEEDED); }
  ...
  */
  ...
  {
    bit_false(value_words,bit(WORD_T));
    st_select_tool(gc_block.values.t);
  }
