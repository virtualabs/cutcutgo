  ...
  if (rt_exec) {
    ...
    if (rt_exec & EXEC_CYCLE_STOP) {
      ...
      if ((sys.state & (STATE_HOLD|STATE_SAFETY_DOOR|STATE_SLEEP)) && !(sys.soft_limit) && !(sys.suspend & SUSPEND_JOG_CANCEL)) {
        ...
        //printString("[protocol_rt_system(): plan_cycle_reinitialize()]\r\n");
      ...
      //printString("[protocol_rt_system(): clear EXEC_CYCLE_STOP]\r\n");
...
{
  //printString("[protocol_exec_rt_suspend()]\r\n");
  #ifdef PARKING_ENABLE
