...
static void report_util_line_feed(void) { printPgmString("\r\n"); }
static void report_util_feedback_line_feed(void) { serial_write(']'); report_util_line_feed(); }
static void report_util_gcode_modes_G(void) { printPgmString(" G"); }
static void report_util_gcode_modes_M(void) { printPgmString(" M"); }
...
void report_realtime_status()
{
  ...
  /* Debug: report PORTG value */
  print_uint32_base10(PORTG);
